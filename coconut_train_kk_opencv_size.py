...
while True:
    ...
    if len(boxes) == 0:
        ...
        for i, box in enumerate(boxes):
            ...
            if label.lower() in ["healthy", "good", "intact"]:  # Adjust according to your healthy class labels
            ...
            # Console output
            print(f"Coconut {i+1}: Class={label}, Confidence={confidence:.2f}, {weight_label}")
