...
while True:
    ...
    if len(boxes) == 0:
        ...
        for i, box in enumerate(boxes):
            ...
            # Console output
            print(f"Coconut {i+1}: Class={label}, Confidence={confidence:.2f}, Maturity={maturity_label}, {weight_label}")

    cv2.imshow("Coconut Detection + Classification + Weight + Maturity", frame)
